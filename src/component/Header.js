    ...
    <header className="bg-[#ff5200] font-serif">
        <div className="flex  justify-between max-w-screen-xl mx-auto py-8 ">   
           ...
           <div  className=" text-white text-base font-bold flex gap-15 items-center"> 
            ...
            <a  target="_blank" className="border border-white py-3 px-4 rounded-2xl" href="https://www.swiggy.com/corporate/">Get the app</a>
            <a  target="_blank"  className="border border-black bg-black py-3 px-4 rounded-2xl"  href="https://www.swiggy.com/corporate/">Sign in</a>
           ...
           <div className="max-w-[70%] container mx-auto flex gap-5 mt-10">
              <input className="bg-white  w-[70%] text-xl  px-6 py-4 rounded-2xl" placeholder="Delhi, India"></input>
              <input className="bg-white w-[55%]  text-xl  px-6 py-4  rounded-2xl"  placeholder="Search for restaurants and items for more"></input>
           </div>
